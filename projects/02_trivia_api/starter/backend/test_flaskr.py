...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_post_question_failed(self):
    ...
    def test_post_search_question_failed(self):
    ...
    def test_get_category_question_failed(self):
    ...
    def test_post_play_quiz_failed(self):
